...
<head>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6Lc5GsQpAAAAANgwIm6g9BtrsVJNDB3UbT2yUnNj"></script>
    <style>
        .error{color:red}
    </style>
</head>
        ...
        $('#form').submit(function(event) {
            if(button_enviar)
            {
                ...
                grecaptcha.ready(function() {
                    grecaptcha.execute('6Lc5GsQpAAAAANgwIm6g9BtrsVJNDB3UbT2yUnNj', {action: 'registro'}).then(function(token) {
